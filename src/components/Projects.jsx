		...
		<>
			<div className="flex flex-col items-start justify-start">
				...
				<ul className="m-0 mt-8 list-none p-0">
					<Project className="mb-16 md:mb-24" title="Shaparak Gallery" description={"ShaparakGallery, one of the firsts and top cosmetic and perfume retail e-commerce stores in Iran. Warehouse and product inventory management system, discount system, product sales in several models"} tech={["PHP", "MySql", "Laravel", "Nova", "Redis", "Vue", "jQuery"]} link={"https://www.shaparakgallery.com"} image={"shaparakgallery.png"} />
					<Project className="mb-16 md:mb-24" title="Amid Esfahani" description={"A minimal, dark portfolio website for myself in multi language."} tech={["PHP", "MySql", "Laravel", "jQuery"]} link={"https://www.amidesfahani.ir"} image={"amidesfahani.png"} />
				</ul>
			</div>
		</>
	);
