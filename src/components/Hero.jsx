...
function Hero() {
	return (
		<>
			...
			<h1 className="text-6xl font-bold text-primary-100">Amid Esfahani</h1>
			<h2 className="mt-3 text-6xl font-bold text-primary-300">Senior Full Stack Developer</h2>
			<p className="mt-6 text-lg">I’m a software engineer specializing in building (and occasionally designing) exceptional digital experiences.</p>
			<div className="mt-8">
